...
const ThormeQuattro = () => {
  ...
  return (
    <main className="bg-[#272b34] flex min-h-screen flex-col items-center justify-between">
      <div className="pt-3 px-3  flex flex-row items-center justify-between w-full">
